...
===================================
User Story:
Я, как сотрудник, хочу использовать мобильное приложение для планирования встреч с другими сотрудниками.

User Case:
Цель: создание новой встречи
Участники: сотрудники компании
Предусловия: сотрудник должен быть авторизирован в системе
Основой поток: доступ к созданию встречи, на какое-то определённое время
Альтернативный: доступ к созданию закрыт, просмотр доступных встреч тоже, предложение авторизоваться.
